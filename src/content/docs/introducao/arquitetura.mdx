...
├── modules/               → Módulos opcionais
    ├── cults_of_tibia/    → Sistema de fake_death que tem na missa cults of tibia
    ├── daily_reward/      → Sistema de recompensas diárias
    ├── gamestore/         → Sistema da loja de tibiacoins
